...
ORCHESTRATOR_ROOT, MODULE_ROOT, MODULE_NAME = setup_ami_paths()  # type: ignore[no-untyped-call]
...
def main() -> int:
    """Main entry point."""
    parser = argparse.ArgumentParser(description="Setup domains module")
